...
const translations = {
  az: {
    ...
    /* Hero */
    bio: "Salam, mən Elvinəm. Ekranda gördüyün hər şeyin arxasında kod var — mən həmin kodu yazıram. Frontend üzərində fokuslanıram, təmiz, sürətli və gözəl.",
    ...
    p1_desc:
      "Litva'da specialty qəhvə dükanı üçün hazırladığım çoxdilli sayt. Menyu, foto qalereya, iş saatları.",
    p2_title: "Ərkivan Restoran",
    p2_desc:
      "Sumqayıtda Taliş mətbəxi restoranı üçün sayt. Tam menyu, foto qalereya, üç dil dəstəyi.",
    p3_title: "Bu Portfeyl",
    p3_desc:
      "Özüm üçün hazırladığım minimalist portfeyl saytı. Sıfırdan, şablonsuz.",
    p4_title: "La Chateau Restoran",
    p4_desc:
      "Sumqayıtda Xəzər dənizi kənarında yerləşən La Chateau restoranı üçün hazırladığım sayt. Rezervasiya sistemi, menyu, foto qalereya.",
    p5_title: "Sənən Ət",
    p5_desc:
      "Sumqayıtda fəaliyyət göstərən halal ət mağazası üçün hazırladığım sayt. Ön sifariş sistemi, məhsul qalereyası, WhatsApp inteqrasiyası.",
    p6_title: "Melan Lounge",
    p6_desc:
      "Sumqayıtda premium lounge üçün hazırladığım sayt. Tam menyu, məkan qalereyası, video bölməsi, rezervasiya sistemi.",
    p7_title: "Sky Cake",
    p7_desc:
      "Bakıda əl işi tort və şirniyyat mağazası üçün hazırladığım sayt. Sifariş sistemi, məhsul kataloqu, foto qalereya.",
    p8_title: "Yavər Sərdarlı — Barber",
    p8_desc:
      "Sumqayıtda professional barber üçün hazırladığım sayt. Rezervasiya sistemi, xidmətlər, foto qalereya, üç dil dəstəyi.",
    p9_title: "KOMEDİXANA",
    p9_desc:
      "Xəzər TV-nin məşhur komediya verilişi üçün hazırladığım rəsmi sayt. Bilet sistemi, bölümlər, aktyor heyəti, sponsor bölməsi.",
  ...
  en: {
    ...
    p1_title: "This.is.Coffee — Utena",
    p1_desc:
      "A multilingual website for a specialty coffee shop in Lithuania. Menu, photo gallery, opening hours.",
    p2_title: "Ərkivan Restaurant",
    p2_desc:
      "A website for a Talysh cuisine restaurant in Sumqayit. Full menu, photo gallery, three-language support.",
    p3_title: "This Portfolio",
    p3_desc:
      "A minimalist portfolio site I built for myself. From scratch, no templates.",
    p4_title: "La Chateau Restaurant",
    p4_desc:
      "A website for La Chateau restaurant on the Caspian Sea coast in Sumqayit. Reservation system, menu, photo gallery.",
    p5_title: "Sənən Ət",
    p5_desc:
      "A website for a halal butcher shop in Sumqayit. Pre-order system, product gallery, WhatsApp integration.",
    p6_title: "Melan Lounge",
    p6_desc:
      "A website for a premium lounge in Baku. Full menu, venue gallery, video section, reservation system.",
    p7_title: "Sky Cake",
    p7_desc:
      "A website for a handcrafted cake and pastry shop in Sumqayit. Order system, product catalogue, photo gallery.",
    p8_title: "Yavər Sərdarlı — Barber",
    p8_desc:
      "A website for a professional barber in Sumqayit. Reservation system, services, photo gallery, three-language support.",
    p9_title: "KOMEDİXANA",
    p9_desc:
      "Official website for KOMEDİXANA, Azerbaijan's popular comedy show on Xəzər TV. Ticket system, episodes, cast, sponsors.",
    p10_title: "Grooming House",
    p10_desc:
  ...
  ru: {
    ...
    p1_title: "This.is.Coffee — Utena",
    p1_desc:
      "Многоязычный сайт для specialty кофейни в Литве. Меню, фотогалерея, часы работы.",
    p2_title: "Ресторан Ərkivan",
    p2_desc:
      "Сайт для ресторана талышской кухни в Сумгаите. Полное меню, галерея, поддержка трёх языков.",
    p3_title: "Это портфолио",
    p3_desc:
      "Минималистичный портфолио-сайт, который я создал для себя. С нуля, без шаблонов.",
    p4_title: "Ресторан La Chateau",
    p4_desc:
      "Сайт для ресторана La Chateau на берегу Каспийского моря в Сумгаите. Система бронирования, меню, фотогалерея.",
    p5_title: "Sənən Ət",
    p5_desc:
      "Сайт для халяльного мясного магазина в Сумгаите. Система предзаказа, галерея, интеграция с WhatsApp.",
    p6_title: "Melan Lounge",
    p6_desc:
      "Сайт для премиум-лаунжа в Сумгаите. Полное меню, галерея, видеораздел, система бронирования.",
    p7_title: "Sky Cake",
    p7_desc:
      "Сайт для кондитерской ручной работы в Баку. Система заказов, каталог продуктов, фотогалерея.",
    p8_title: "Явяр Сярдарлы — Барбер",
    p8_desc:
      "Сайт для профессионального барбера в Сумгаите. Система бронирования, услуги, фотогалерея, поддержка трёх языков.",
    p9_title: "KOMEDİXANA",
    p9_desc:
      "Официальный сайт популярного комедийного шоу KOMEDİXANA на Xəzər TV. Система билетов, эпизоды, актёры, спонсоры.",
    p10_title: "Grooming House",
    p10_desc:
...
if (cursor && cursorRing) {
  ...
  document
    .querySelectorAll("a, button, .project-card, .skill-bar")
    .forEach((el) => {
...
// WebMCP - AI agent tool definitions
if (navigator.modelContext) {
  navigator.modelContext.provideContext({
    tools: [
      {
        name: "get_portfolio_info",
        description: "Get information about Elvin Eyvazov, frontend developer",
        inputSchema: {
          type: "object",
          properties: {},
          required: [],
        ...
        execute: async () => {
          return {
            ...
            contact: "elvin.eyvazov1@mail.ru",
            website: "https://elvineyvazov.shop",
          };
        },
      },
      {
        name: "get_projects",
        description: "Get list of projects built by Elvin Eyvazov",
        inputSchema: {
          type: "object",
          properties: {},
          required: [],
        ...
        execute: async () => {
          return {
            projects: [
              {
                name: "La Chateau Restoran",
                url: "https://elleo15.github.io/la-chateau-website/",
              },
              {
                name: "Melan Lounge",
                url: "https://elleo15.github.io/melan-lounge/",
              },
              { name: "Sky Cake", url: "https://samahmadova.shop/" },
              {
                name: "Yavər Sərdarlı Barber",
                url: "https://elleo15.github.io/barber-yaver/",
              },
              {
                name: "KOMEDİXANA",
                url: "https://elleo15.github.io/Komedixana/",
              },
              {
                name: "Grooming House",
                url: "https://elleo15.github.io/grooming-house/",
              },
            ],
          };
        },
      },
      {
        ...
        execute: async ({ section }) => {
          ...
          return { success: true, navigatedTo: section };
        },
      },
    ],
  });
